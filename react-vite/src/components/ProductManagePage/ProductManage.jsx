...
function ProductManage() {
    ...
    <span><Link to="/products/new">Add new product</Link></span>
    ...
    return (
        <div className="product_manage_container">
            ...
            <div key={product.id} className="product_manage_single_container">
                ...
                <div>
                    <button className="drop_down_button" ref={buttonRef} onClick={(e) => toggleMenu(e, product.id)}>
                        <IoSettingsOutline />
                    </button>
                    {showDropDownId === product.id && (
                    <div className="drop_down_container">
                        <button className="drop_down_item"><Link to={`/products/${product.id}/edit`}>Edit</Link></button>
                        <button onClick={() => handleDeleteClick(product.id)}className="drop_down_item">Delete</button>
                    </div>)}                        
                </div>
            </div>
           ))}
